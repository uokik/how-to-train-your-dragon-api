...
var Dragons = []Dragon{
	...
	{ID: 59, Name: " ", Species: "Hobblegrunt", Class: "Stoker", Description: "Hobblegrunts are considered lucky dragons and that they can predict certain things, both good and bad, a split second before they actually happen"},
	{ID: 60, Name: " ", Species: "Raincutter", Class: "Sharp", Description: "Raincutters share distaste for the sun and warm weather, since those signal that feeding time is over"},
	{ID: 61, Name: " ", Species: "Threadtail", Class: "Stoker", Description: "Threadtails are allergic to their own poison. They often roll around in Dragonberry bushes to scratch their itchy skin"},
