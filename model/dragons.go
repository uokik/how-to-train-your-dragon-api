...
var Dragons = []Dragon{
	...
	{ID: 16, Name: " ", Species: "Terrible Terror", Class: "Stoker", Description: "Inquisitive and curious animals, their only downfall is their territorial in-fighting"},
	...
	{ID: 53, Name: " ", Species: "Thunderclaw", Class: "Tracker", Description: "Thunderclaws are pretty cute. Feisty, but cute"},
	{ID: 54, Name: " ", Species: "Triple Stryke", Class: "Strike", Description: "This giant Strike Class Dragon's three tails can slash through its enemies or snake around its prey"},
	{ID: 55, Name: " ", Species: "Typhoomerang", Class: "Stoker", Description: "Much like the rings inside a tree, the scorch mark can tell you the age and thus the size of the Typhoomerang in question"},
	{ID: 56, Name: " ", Species: "Windgnasher", Class: "Tracker", Description: "With a strong enough wind, these humped back dragons can pick up a scent from anywhere in the archipelago or beyond"},
	{ID: 57, Name: " ", Species: "Windstriker", Class: "Sharp", Description: "A Sharp Class skydiver that is literally full of hot air! Instead of breathing fire they shoot super-heated blasts of air that sets their foes ablaze"},
